...
!function(e,t){"use strict";t.module("gs.preloaded",[]).directive("script",["$preloaded",function(e){return{restrict:"E",link:function(n,r,d){var a;"text/preloaded"===d.type&&(a=JSON.parse(r.text()),d.hasOwnProperty("name")?e[d.name]=a:t.extend(e,a))}}}]).constant("$preloaded",{})}(window,window.angular);
